...
### GraphQL - Requête getAllAccounts

![GraphQL getAllAccounts](screenshots/graphql-get-all-accounts.png)

### GraphQL - Mutation addAccount

![GraphQL addAccount](screenshots/graphql-add-account.png)
